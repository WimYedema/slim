...
**Still no lightweight mode** -- "The signal grid is 4 stages x 3 perspectives = 12 cells per opportunity. For a team of 6, that's still a lot of ceremony. If I could hide the Decompose row until I actually get there, the grid would feel more approachable."
...
## Round 3: Pipeline Stage View -- Priya x Dani Discussion
...
### Follow-up: Zoom Density (Priya x Dani x Sam x Raj)

**Agreed**: One zoom level is sufficient. Two toggles (zoomed x detail-pane-open) yield four clean states:
...
3. Prefix horizon labels: "* now", "o next"
